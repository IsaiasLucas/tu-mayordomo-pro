...
const NotFound = () => {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center" style={{ minHeight: 'calc(var(--vh, 1vh) * 100)', background: 'linear-gradient(135deg, hsl(270 70% 60%) 0%, hsl(280 80% 70%) 50%, hsl(285 75% 65%) 100%)' }}>
