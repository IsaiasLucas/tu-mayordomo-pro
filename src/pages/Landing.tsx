    ...
    <div className="landing-dark min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative z-10 container mx-auto px-4 pt-8 pb-16 sm:pt-12 sm:pb-20 md:pt-20 md:pb-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-[2.25rem] sm:text-5xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 sm:mb-6 px-2">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-6 sm:mb-8 leading-relaxed px-2">
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-[1.625rem] sm:text-4xl md:text-4xl font-bold mt-2 mb-3 sm:mb-4 px-2">
                ¿Cómo empezar a usar Tu Mayordomo?
              </h2>
              <p className="text-muted-foreground text-base sm:text-xl max-w-xl mx-auto px-2">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-4">
              ...
              <ScrollReveal delay={150} direction="up">
                ...
                <div className="relative bg-card/50 backdrop-blur-lg rounded-3xl p-6 border border-border/50 h-full">
                  ...
                  <h3 className="text-xl sm:text-xl font-bold mb-3 flex items-center gap-2">
                    <Smartphone className="w-5 h-5 text-accent" />
                    Completa tu perfil
                  </h3>
                  
                  <p className="text-muted-foreground text-base sm:text-base mb-6">
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal>
            <div className="text-center mb-8 sm:mb-12">
              <span className="text-primary text-sm sm:text-sm font-semibold tracking-wider uppercase">
          ...
          <ScrollReveal>
            <div className="text-center mt-10 sm:mt-16 px-2">
              <p className="text-xl sm:text-2xl md:text-3xl font-medium text-foreground mb-6 sm:mb-8">
        ...
        <div className="container mx-auto px-4">
          ...
          <ScrollReveal direction="left">
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-16 items-center max-w-6xl mx-auto mb-12 sm:mb-20 md:mb-32">
              <div className="order-2 md:order-1">
                ...
                <h3 className="text-xl sm:text-3xl md:text-3xl font-bold mb-3 sm:mb-4">
                  Registra gastos como si chatearas con un amigo
                </h3>
                <p className="text-muted-foreground text-base sm:text-xl mb-4 sm:mb-6">
                ...
                <ul className="space-y-2 sm:space-y-3">
                  <li className="flex items-center gap-2 sm:gap-3 text-muted-foreground text-base sm:text-xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-16 items-center max-w-6xl mx-auto mb-12 sm:mb-20 md:mb-32">
            <div className="order-2 md:order-1">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-center gap-2 sm:gap-3 text-muted-foreground text-base sm:text-base">
