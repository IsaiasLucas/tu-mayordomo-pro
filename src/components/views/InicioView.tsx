  ...
  return (
    <main className="px-6 py-6 pb-32 space-y-6">
      ...
      <a
        ...
        className="fixed bottom-24 sm:bottom-32 right-4 sm:right-5 z-40 group touch-manipulation"
        title="Chatear con Tu Mayordomo"
      >
        <div className="relative bg-gradient-to-br from-purple-600 to-blue-600 rounded-full p-3 sm:p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95">
          <div className="absolute inset-0 rounded-full bg-purple-400 animate-ping opacity-20"></div>
          
          <svg className="relative w-6 h-6 sm:w-7 sm:h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
